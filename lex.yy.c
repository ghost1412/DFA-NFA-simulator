...
Properties* _Cmd_Input(int argc, char* argv[]){
	...
	for(int i=0; i<argc; i++){
		...
		properties->_sCount = atoi(argv[2]) + 1;
...
YY_RULE_SETUP
#line 227 "mylex.l"
{if(properties->_is_dfa_nfa) _isMatched(_DTransition_Table, properties, _final, yytext);else  _isMatched(_NTransition_Table, properties, _final, yytext);}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 228 "mylex.l"
